...
const NavigationBar = async () => {
  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between border-2 border-purple-500 bg-background/80 px-4 shadow-md backdrop-blur-sm transition-transform duration-300 ease-in-out sm:px-6 lg:px-8">
      <NavLinks />
      <NavigationPath />
