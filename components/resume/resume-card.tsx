...
const HeaderSection = ({
    ...
    <header className="text-center mb-4">
        ...
        <Link href={ website } target="_blank" rel="noopener noreferrer" className="text-muted-foreground">
            { website }
        </Link>
    </header>
);
...
const ExperienceSection = ({ experience }: { experience: ResumeType['experience'] }) => (
...
const PublicationsSection = ({ publications }: { publications: ResumeType['publications'] }) => (
            ...
            <Card key={ index } className="mb-2 print:shadow-none">
                ...
                <CardContent>
                    <div className="flex gap-2">
                        <Link href={ pub.doi } target="_blank" rel="noopener noreferrer" className="text-primary underline">
                            Journal Information: { pub.edition }
                        </Link>
                    </div>
                    <div className="flex justify-between gap-2">
                        { pub.pdf && (
                            <Link href={ pub.pdf } className="text-primary underline">
...
const EducationSection = ({ education }: { education: ResumeType['education'] }) => (
...
const groupByCategory = (skills: ResumeType["skills"]) => {
    return skills.reduce((acc, skillObj) => {
