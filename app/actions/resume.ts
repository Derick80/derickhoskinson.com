    ...
    const generateResumeAST = (): ASTResume => {
        return {
            ...
            children: [
                ...
                },
                {
                    ...
                    children: cv.experience.map((job: any) => ({
                        ...
                        children: [
                            ...
                            {
                                type: "duties",
                                children: job.duties.map((duty: string) => ({ type: "duty", value: duty })),
                            },
                        ],
                    })),
                },
                {
                    type: "skills",
                    children: cv.skills.map((skill: any) => ({ type: "skill", value: skill.skill })),
                },
                {
                    type: "education",
                    children: cv.education.map((edu: any) => ({
                        ...
                        children: [
                            ...
                            {
                                type: "duties",
                                children: edu.duties.map((duty: string) => ({ type: "duty", value: duty })),
                            },
                        ],
                    })),
                },
